...
--
-- Name: featured_post; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: featured_post_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: featured_post_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: featured_post id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Data for Name: featured_post; Type: TABLE DATA; Schema: public; Owner: -
--

INSERT INTO public.featured_post VALUES (1, 'Bienvenido 222', 'Primera publicación destacada 22222222', 'Este es el contenido inicial. 222222222', NULL);
...
INSERT INTO public.posts VALUES (2, 'Prueba', 'para ver que onda', 'Patricia Bullrich define el lugar donde quedará detenida Cristina Kirchner: qué opciones se evalúan y el pedido de los abogados
...
INSERT INTO public.posts VALUES (3, 'SSSSSSSSSSSS', 'SSSSSSSSSSSSSSSS', 'ASSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSS', 'https://www.quepasasalta.com.ar/files/image/228/228451/671a8daa6029e.png', '2025-05-29', '2025-06-20');
...
INSERT INTO public.testimonials VALUES (1, 'Juan Perez ', 'me encanta esta pagina !!!', 'Argentina', '2025-06-12 11:24:16.435');


--
-- Name: featured_post_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--
...
--
-- Name: featured_post featured_post_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
